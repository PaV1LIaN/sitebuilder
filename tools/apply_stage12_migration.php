...
?><!doctype html><html lang="ru"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Миграция SiteBuilder — этап 12</title><link rel="stylesheet" href="../assets/tools/apply-stage12-migration.css?v=20260917"></head><body><div class="card"><h1>Миграция этапа 12</h1><p>Создаёт реестр резервных копий сайта и историю проверок целостности.</p><p><strong>Перед запуском:</strong> резервная копия PostgreSQL и каталога <code>/upload/sitebuilder</code>, установленный этап 11.</p><?php if($message):?><div class="notice ok"><?=sbStage12Escape($message)?></div><?php endif?><?php if($error):?><div class="notice err"><?=sbStage12Escape($error)?></div><?php endif?><form method="post"><?=bitrix_sessid_post()?><button>Применить миграцию этапа 12</button></form></div></body></html>
