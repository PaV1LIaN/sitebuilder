...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!check_bitrix_sessid()) {
        ...
        try {
            $result = MigrationService::applyPending((int)$USER->GetID());
...
<head>
    ...
    <title>Миграция Stage 22</title>
    <link rel="stylesheet" href="../assets/tools/apply-stage22-migration.css?v=20260917">
</head>
<body><div class="box">
<h1>SiteBuilder Stage 22</h1>
<p>Добавляет журнал сверок и реестр управляемых прав портала и Битрикс.Диска.</p>
