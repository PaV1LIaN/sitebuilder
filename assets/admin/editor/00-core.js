...
var state = {
    ...
    pageAccessItems: [],
    pageAccessUserSearchResults: [],
    selectedPageAccessUser: null,
    pageAccessUserSearchTimer: null,
    pageAccessLoadedPageId: 0,
    pageAccessLoadingPageId: 0,
    pageAccessContextPageId: 0,
    historyItems: [],
    historyUsers: {},
    historyEntityType: '',
    historyEntityId: 0,
