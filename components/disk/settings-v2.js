/* =========================================================
   SITEBUILDER / DISK SETTINGS 2.0 / v9 NATIVE-FIX
...
(function () {
    ...
    /*
     * Version handling is native again in v9.
     * components/disk/script.js receives the current blockVersion from
     * getSettings/getRootOptions and saveSettings keeps normal optimistic
     * locking. No fetch interception or automatic conflict overwrite.
     */
